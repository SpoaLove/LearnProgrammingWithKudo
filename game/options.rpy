...
define config.name = _("LearnProgrammingWithKudo")
...
define build.name = "LearnProgrammingWithKudo"
...
define config.save_directory = "LearnProgrammingWithKudo-1529172719"
